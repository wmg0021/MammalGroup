...
MyID=aubclsc0330        ## Example: MyID=aubtss


WD=/scratch/$MyID/PracticeRNAseq_Mamnmal          ## Example:/scratch/$MyID/PracticeRNAseq  
DD=$WD/RawData
RDQ=RawDataQuality
...
REFD=$WD/ReferenceGenome        ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for the garter snake
...
RESULTSD=/home/$MyID/PracticeRNAseq_Mamnmal/Counts_H_S_2024      ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S
REF=rat               ## This is what the "easy name" will be for the genome reference
...
fasterq-dump SRR11535186
fasterq-dump SRR11535187
fasterq-dump SRR11535188
fasterq-dump SRR11535189
fasterq-dump SRR11535192
fasterq-dump SRR11535193
...
cp /home/${MyID}/project/referencegenome/${REF}.fna .
cp /home/${MyID}/project/referencegenome/${REF}.gff .
...
hisat2-build --ss ${REF}.ss --exon ${REF}.exon ${REF}1.fna norwayrat_index
